...
const Contact = () => {
    return (
        <div id='Contact' className='contactstyle vh-100 w-100'>
            <h1 className='contacttitle w-33 shadow-1 center br3'>Contact</h1>
            <div className='mailsection w-70 center ma4'>
                <h2 className='f2 mb5'>Send me an email :</h2>
                <a className='clickToMailButton' href='mailto:alex.monteil@outlook.com'>Email me</a>
            </div>
            <h2 className='f3 ma5'>Here are my social media platforms</h2>
